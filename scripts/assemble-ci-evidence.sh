...
stage_measurements=$(jq -n \
  ...
  '{compile:$compile[0]|{wall_ms,peak_rss_kib},build:$build[0]|{wall_ms,peak_rss_kib},test:$test[0]|{wall_ms,peak_rss_kib},conformance:$conformance[0]|{wall_ms,peak_rss_kib},integration:$integration[0]|{wall_ms,peak_rss_kib}}')
