...
printf '%s\n' "$inventory" > "$stage_root/inventory.json"
...
jq -n \
  ...
  --arg runner "$runner" \
  --arg stage_field_count "$stage_field_count" \
  --arg go_test_total "$go_test_total" \
  --arg go_test_selected "$go_test_selected" \
  --arg go_test_executed "$go_test_executed" \
  --arg go_test_reused "$go_test_reused" \
  --arg go_test_failed "$go_test_failed" \
  --arg go_test_unknown "$go_test_unknown" \
